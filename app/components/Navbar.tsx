...
export default function Navbar() {
  ...
  return (
    <>
      ...
      >
        <nav className="w-full max-w-3xl bg-[#2A2A2A] text-white px-4 sm:px-6 py-2.5 sm:py-3.5 rounded-xl sm:rounded-2xl flex items-center justify-between shadow-xl border border-white/10 backdrop-blur-md">
          <Link
            href="/"
            onClick={scrollToTop}
